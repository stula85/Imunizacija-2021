...
<div class="col-sm-12">
	<div class="row">
		<div class="col-sm-12 col-md-4">
			<a href="<?php echo base_url('opstine');?>" class="btn btn-secondary">Очисти резултат претраге</a>
		</div>
		...
		<tbody>
			<?php foreach($podaci as $podatak) : ?>
				<tr class="table-default">
					...
					<td width="200"><a href="<?php echo base_url('opstine/izmjeni/');?><?php echo $podatak['id_opstine']; ?>" class="btn btn-info pull-left" data-toggle="tooltip" data-placement="bottom" title="Измјени"><i class="fas fa-edit"></i></a> <button onclick="obrisiPacijenta(<?php echo $podatak['id_opstine'];?>)" class="btn btn-danger pull-left ml-10"><i class="fas fa-trash"></i></button></td></td>
				</tr>
			<?php endforeach; ?>
		</tbody>
	</table> 
