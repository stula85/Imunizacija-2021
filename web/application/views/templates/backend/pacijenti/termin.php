		...
		<div class="tab-pane fade show active" id="sadrzaj_pacijent">
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<div class="form-group">
						<a href="<?php echo base_url('vakcinacije/nova/') . $termin['id_termina'];?>" class="btn btn-success btn-lg" style="margin-left: 20px;"><i class="fas fa-stethoscope"></i> Вакцинација</a>
					</div>
				</div>
			</div>
		</div>
