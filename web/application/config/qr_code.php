...
$config['cachedir'] 	= 'assets/backend/tmp/cache/'; //string, the default is tmp/cache/
$config['imagedir'] 	= 'assets/backend/qr/'; //string, the default is tmp/qr_codes/
$config['errorlog'] 	= 'assets/backend/tmp/logs/'; //string, the default is tmp/logs/
